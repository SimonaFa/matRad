classdef (Abstract) matRad_ClusterDoseObjective < matRad_ClusterDoseOptimizationFunction
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    methods %(Abstract)
        ...
        function fDoseGrad   = computeClusterDoseObjectiveGradient(obj,dose)
            error('Function needs to be implemented!');
        end
    ...
    methods (Access = public)
        ...
        % constructor of matRad_ClusterDoseObjective
        function obj = matRad_ClusterDoseObjective(varargin)
            %default initialization from struct (parameters & penalty)
            obj@matRad_ClusterDoseOptimizationFunction(varargin{:});
        end
        
        %Overloads the struct function to add Objective related information
        %to output struct
        function s = struct(obj)
            s = struct@matRad_ClusterDoseOptimizationFunction(obj);
