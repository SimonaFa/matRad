classdef matRad_ClusterDoseVariance < ClusterDoseObjectives.matRad_ClusterDoseObjective
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    methods
        function obj = matRad_ClusterDoseVariance(penalty)
        ...
        function fClusterDose = computeClusterDoseObjectiveFunction(obj,clusterDose)
            ...
            fClusterDose = obj.penalty * var(clusterDose);
        ...
        function fClusterDoseGrad   = computeClusterDoseObjectiveGradient(obj,clusterDose)
            ...
            fClusterDoseGrad = obj.penalty * 2/(numel(clusterDose) - 1) * (clusterDose - mean(clusterDose));
