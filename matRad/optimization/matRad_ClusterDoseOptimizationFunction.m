classdef (Abstract) matRad_ClusterDoseOptimizationFunction
% matRad_ClusterDoseOptimizationFunction. Superclass for objectives and constraints
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    methods (Access = public)
        function doseParams = getDoseParameters(obj)
            ...
            ix = cellfun(@(c) isequal('clusterdose',c),obj.parameterTypes);
    ...
    methods (Static)
        ...
        function obj = createInstanceFromStruct(s)            
            try
                ...
                if isfield(s,'type')
                    s = matRad_ClusterDoseOptimizationFunction.convertOldOptimizationStruct(s);
                end
        ...
        function s = convertOldOptimizationStruct(old_s)
            ...
            switch old_s.type
                ...
                case 'square deviation'
                    s.className = 'ClusterDoseObjectives.matRad_cdSquaredDeviation';
