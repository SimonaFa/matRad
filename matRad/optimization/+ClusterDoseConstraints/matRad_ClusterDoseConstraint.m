classdef (Abstract) matRad_ClusterDoseConstraint < matRad_ClusterDoseOptimizationFunction
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    methods %(Abstract)
        ...
        function cClusterDoseJacob   = computeDoseConstraintJacobian(obj,clusterdose)
          error('Function needs to be implemented!');
        end
    ...
    methods (Access = public)
        ...
        function obj = matRad_ClusterDoseConstraint(varargin)
